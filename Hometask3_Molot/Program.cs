    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            }
            {
                ...
                List<string> someStrings = new List<string> { "1qwerty", "cqwertyc", "cqwe", "c" };
                IEnumerable <int> length = from x in someStrings select x.Length;
                int sum = length.Sum();
            ...
            }
            {
                ...
                //TODO
                List<string> str = new List<string> { "1qwerty", "cqwertyc", "cqwe", "c" };
                IEnumerable <char> firstLetters = from x in str select (x.First());
                //IEnumerable <string> firstLettersString = firstLetters.OfType<string>();
                //string firstLetterString = firstLettersString.Aggregate((x,y) => x+y);
...

            {
                ...
                var res = n1.Join(n2, x => x % 10, y => y % 10, (x, y) => x.ToString() + " - " +
                y.ToString());
            }
            {
